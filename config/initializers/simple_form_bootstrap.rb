...
SimpleForm.setup do |config|
  ...
  config.wrappers :inline_input_group, class: 'col-12' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  # Just for -sm
  config.wrappers :inline_input_group_sm, class: 'col-12' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    ...
    b.optional :readonly
    b.use :label, class: 'form-label'
    b.wrapper :input_group_tag, class: 'input-group input-group-sm' do |ba|
      ba.optional :prepend
      ba.use :input, class: 'form-control', error_class: 'is-invalid', valid_class: 'is-valid'
      ba.optional :append
      ba.use :full_error, wrap_with: { class: 'invalid-feedback' }
  ...
  config.wrappers :floating_input_group, class: 'mb-3' do |b|
    ...
    b.wrapper :input_group_tag, class: 'input-group' do |igw|
      ...
      igw.wrapper :floating_tag, class: 'form-floating flex-1' do |ig|
        ig.use :input, class: 'form-control', error_class: 'is-invalid', placeholder: "placeholder" #, valid_class: 'is-valid'
        ig.use :label
      end
      igw.optional :append
      igw.use :full_error, wrap_with: { class: 'invalid-feedback d-block' }
    end
    b.use :hint, wrap_with: { class: 'form-text' }
  end
  ...
  config.wrappers :floating_labels_form, class: 'form-floating mb-3' do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :input, class: 'form-control', error_class: 'is-invalid', placeholder: "placeholder"#, valid_class: 'is-valid'
    b.use :label
    b.use :full_error, wrap_with: { class: 'invalid-feedback' }
    b.use :hint, wrap_with: { class: 'form-text' }
  end
